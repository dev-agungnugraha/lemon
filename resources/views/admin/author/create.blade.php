...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('admin.author.store') }}" method="POST" id="formPenulis">
                @csrf
            <div class="card-body">
                <div class="form-group">
                <label for="name">Nama Penulis</label>
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}"placeholder="Masukkan data penulis">
                </div>
            </div>
            <!-- /.card-body -->
